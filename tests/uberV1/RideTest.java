...
public class RideTest {
	...
	public void testAddDriver() {
		Ride ride = new Ride(new Point(0,0),new Client(null,"Jake",0,new Point(0,1)),10,10);
		Driver driver = new Driver(null, "Max", 0, 2, new Point(0,2));
		ride.addDriver(driver);
		assertEquals(ride.getPrice(),20,.01);
	}

	@Test
	public void testEstimateWait() {
		Ride ride = new Ride(new Point(0,0),new Client(null,"Jake",0,new Point(0,1)),10,10);
		Driver driver = new Driver(null, "Max", 0, 3, new Point(0,2));
		ride.addDriver(driver);
	...
	public void testEstimateTravelTime() {
		Ride ride = new Ride(new Point(0,0),new Client(null,"Jake",0,new Point(0,1)),10,10);
		Driver driver = new Driver(null, "Max", 0, 4, new Point(0,2));
		ride.addDriver(driver);
